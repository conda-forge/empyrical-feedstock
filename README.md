...
Once the `conda-forge` channel has been enabled, `empyrical` can be installed with:

```
conda install empyrical
```

It is possible to list all of the versions of `empyrical` available on your platform with:
